...
public class SaveAndLoad : MonoBehaviour
{
    ...
    private void SetActiveSkill()
    {
        ...
        name = "변이 파리채";
        saveData.AskillDic.Add(name, new ActiveSkill(name,
                                                    "전방에 거대한 파리채로 게임판을 강하게 내리쳐, 일정 갯수의 플루토 타일들을 다른 랜덤 타일들로 바꿉니다. \n" +
                                                    "만약, 게임판에 플루토 타일이 하나도 없다면, 사용해도 효과가 없으니 주의해야합니다.",
                                                    1,
                                                    50,
                                                    20f,
                                                    5));
        ...
        name = "잭프로스트 빙수";
        saveData.AskillDic.Add(name, new ActiveSkill(name,
                                                    "잭프로스트 형상의 빙수기를 조립하여 시원한 얼음을 만들어서, 적의 움직임을 일정 시간동안 멈추게 만듭니다. \n" +
                                                    "그러나, 상대가 그로기 상태일때는, 움직임을 멈추게 할 수 없습니다.",
                                                    1,
                                                    70,
                                                    40f,
                                                    5));
    ...
    private void SetPassiveSkill()
    {
        ...
        name = "현자의 돌";
        saveData.PskillDic.Add(name, new PassiveSkill(name,
                                                    "마도학의 성배 현자의 돌을 촉매로 사용함으로서 이전까지와는 다른 수준의 성취를 이루어 냅니다. \n" +
                                                    "퍼즐을 완성할 때 마다, 획득하는 점수가 상승합니다.",
                                                    1,
                                                    1.0f));

        name = "붉은 사탕";
        saveData.PskillDic.Add(name, new PassiveSkill(name,
                                                    "마도학의 정수라고도 할 수 있는 붉은 사탕은, 현자의 돌을 가공하여 만든 세상에서 가장 귀중하면서도 위험한 사탕입니다. \n" +
